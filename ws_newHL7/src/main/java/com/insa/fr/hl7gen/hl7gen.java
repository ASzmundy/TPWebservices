...
//MSH10 Message control ID (R)
    ...
    private String IPP;// ID permanent patient
    private String NOM;//
    private String PRENOM;//
    private String INTIT;//Intitulé ( civilité )
    private String NOMMAR;//nom de marié
    ...
    private String DDS;//Date de séjour
    private String UF;//Unité fonctionelle (numéro)
    private String CHAMBRE;
    private String LIT;
    private String UFMED;//UF médical (numéro)
    private String NUMPAS;//Numéro de passage ( 0 )
...
//parser la date
    ...
    private String Date_to_Date_HL7_long(String dateComplexe) {
        //parser la date
        System.out.println(dateComplexe);
